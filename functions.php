<?php
/**
 * Returns true is user is on a mobile device
 *
 * 
 */
 ...
 * Outputs site assets
 *
 * This function is put in header or footer and outputs the site's assets (js, css, ga, etc)
 */

    function petelower_return_assets() { 
        petelower_return_googleanalytics();
        petelower_return_styles();
        petelower_return_scripts();
    }
 ...
 */
    ...
    function petelower_return_styles() {
        ?> 
            <!-- STYLES -->
...
/**
 * Outputs Google analytics information
 *
 * 
 */

    function petelower_return_googleanalytics() { ?>
        <!-- GOOGLE ANALYTICS -->
        <script>
